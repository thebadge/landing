      ...
      <MainContainer>
        ...
        <BoxBadgeTypes>
          ...
          <BadgeTypeDescription
            ...
            body={`These badges will be an on-chain representation of off-chain information. There are going to be strategies developed ad-hoc for each type of badge. In order to mint these badges evidence has to be presented and pass throug a curation process in Kleros.`}
            image={svg2}
